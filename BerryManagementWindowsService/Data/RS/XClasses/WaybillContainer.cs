...
{
    public class WaybillContainer
    {
        public string UserName;
        public string Password;
        public WAYBILL Waybill;
        public XElement XWaybill;
        public RESULT Result;
        public XElement XResult;
        public long TransportWaybillId_DB;
        public long NonTransportWaybillId_DB;
        public bool IsTransportWaybill;

        public WaybillContainer()
        {
            Waybill = new WAYBILL();
            Waybill.GOODS_LIST = new List<WAYBILL.GOODS>();
        }
